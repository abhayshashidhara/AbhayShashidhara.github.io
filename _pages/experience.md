...
During my internship at BOCK AI, I contributed to end-to-end AI workflows for clinical and medical text applications, supporting the full cycle from model experimentation to deployment-ready pipelines. My primary role was fine-tuning compact transformer models to generate diagnostic-style outputs and improving quality through iterative evaluation and refinement. I also helped streamline the training workflow on Google Cloud Vertex AI, reducing iteration time and making it easier to update models as the dataset evolved.
...
At the Center of Excellence in Computational Genomics at RVCE, I worked on early-stage machine learning research prototyping for drug discovery, focused on improving how candidate molecules can be generated and screened. I explored generative modeling approaches using DDPMs to propose new molecules for COVID-related targets and used constraint-guided refinement to steer outputs toward chemically valid structures.

I then prioritized candidates using ADMET-based feature screening to estimate drug-likeness and early safety signals, helping connect model outputs to practical downstream evaluation steps used in real discovery workflows.

I also presented this work at the [AIML BIO International Conference, RVCE, December 2022](https://www.bangalorenewsnetwork.com/news_detail.php?f_news_id=2377).
